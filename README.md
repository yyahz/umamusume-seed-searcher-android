...
- 使用“角色 / 因子 / 结果”三页式手机界面。
- 智能识别下方仍可继续手动选择；红因子一次显示，其他较长目录采用每批 8 项的翻页浏览。
- 结果页固定先显示候选的蓝、红因子，再统一显示候选拥有的全部其他因子。
...
```text
app/build/outputs/apk/debug/uma-seed-searcher-android-v0.1.20-debug.apk
```
