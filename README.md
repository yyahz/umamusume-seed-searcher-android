...
- 使用“角色 / 因子 / 结果”三页式手机界面。
- 智能识别下方仍可继续手动选择，因子目录采用每批 8 项的翻页浏览。
- 结果页固定先显示候选的蓝、红因子，再显示筛选条件和候选拥有的其他全部因子。
...
```text
app/build/outputs/apk/debug/uma-seed-searcher-android-v0.1.19-debug.apk
```
