...
当前版本为 `v0.1.51`，仍处于测试阶段。

本版仅递增版本号，不增加功能，用于测试 v0.1.50 的安装包复用：在已安装的 v0.1.50 中下载本版，暂不安装，退出 App 后重新进入设置，再点击更新，检查是否直接打开系统安装器。
...
```text
app/build/outputs/apk/debug/uma-seed-searcher-android-v0.1.51-debug.apk
```
